...
planet_stac_url: str 
        URL to the PlanetScope STAC. Needs to be provided by the user of generated by habitat_mapping.openeo.build_planet_collection.collection in the habitat_mapping repository.

udm_stac_url: str 
        URL to the Usable Data Mask 2 STAC. Needs to be provided by the user of generated by habitat_mapping.openeo.build_planet_collection.collection in the habitat_mapping repository.
